...
[task_local]
#东东工厂
10 * * * * https://raw.githubusercontent.com/wishcaiji/JD-scripts/master/jd_jdfactory.js, tag=东东工厂, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_factory.png, enabled=true

================Loon==============
[Script]
cron "10 * * * *" script-path=https://raw.githubusercontent.com/wishcaiji/JD-scripts/master/jd_jdfactory.js,tag=东东工厂

===============Surge=================
东东工厂 = type=cron,cronexp="10 * * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/wishcaiji/JD-scripts/master/jd_jdfactory.js

============小火箭=========
东东工厂 = type=cron,script-path=https://raw.githubusercontent.com/wishcaiji/JD-scripts/master/jd_jdfactory.js, cronexpr="10 * * * *", timeout=3600, enable=true
 */
const $ = new Env('东东工厂');
...
const inviteCodes = [`T01546ItFVdPqR3SIhoCjVWnYaS5kRrbAj`, 'T01546ItFVdPqR3SIhoCjVWnYaS5kRrbA'];
!(async () => {
  await requireConfig();
  if (!cookiesArr[0]) {
